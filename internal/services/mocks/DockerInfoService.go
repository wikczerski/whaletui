...
func (_mock *MockDockerInfoService) GetDockerInfo(ctx context.Context) (*models.DockerInfo, error) {
	...
	var r0 *models.DockerInfo
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (*models.DockerInfo, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) *models.DockerInfo); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.DockerInfo)
		}
	}
...
func (_c *MockDockerInfoService_GetDockerInfo_Call) Return(dockerInfo *models.DockerInfo, err error) *MockDockerInfoService_GetDockerInfo_Call {
	_c.Call.Return(dockerInfo, err)
	return _c
}

func (_c *MockDockerInfoService_GetDockerInfo_Call) RunAndReturn(run func(ctx context.Context) (*models.DockerInfo, error)) *MockDockerInfoService_GetDockerInfo_Call {
	_c.Call.Return(run)
	return _c
}
