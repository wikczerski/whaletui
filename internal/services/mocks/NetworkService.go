...
func (_mock *MockNetworkService) ListNetworks(ctx context.Context) ([]models.Network, error) {
	...
	var r0 []models.Network
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) ([]models.Network, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) []models.Network); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.Network)
		}
	}
...
func (_c *MockNetworkService_ListNetworks_Call) Return(vs []models.Network, err error) *MockNetworkService_ListNetworks_Call {
	_c.Call.Return(vs, err)
	return _c
}

func (_c *MockNetworkService_ListNetworks_Call) RunAndReturn(run func(ctx context.Context) ([]models.Network, error)) *MockNetworkService_ListNetworks_Call {
	_c.Call.Return(run)
	return _c
}
