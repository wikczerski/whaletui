...
func (_mock *MockImageService) ListImages(ctx context.Context) ([]models.Image, error) {
...
func (_c *MockImageService_ListImages_Call) Return(vs []models.Image, err error) *MockImageService_ListImages_Call {
	_c.Call.Return(vs, err)
	return _c
}

func (_c *MockImageService_ListImages_Call) RunAndReturn(run func(ctx context.Context) ([]models.Image, error)) *MockImageService_ListImages_Call {
	_c.Call.Return(run)
	return _c
}
