...
func (_mock *MockUIInterface) GetServices() services.ServiceFactoryInterface {
	ret := _mock.Called()
	...
	var r0 services.ServiceFactoryInterface
	if returnFunc, ok := ret.Get(0).(func() services.ServiceFactoryInterface); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(services.ServiceFactoryInterface)
		}
	}
	return r0
}
...
func (_c *MockUIInterface_GetServices_Call) Return(serviceFactoryInterface services.ServiceFactoryInterface) *MockUIInterface_GetServices_Call {
	_c.Call.Return(serviceFactoryInterface)
	return _c
}

func (_c *MockUIInterface_GetServices_Call) RunAndReturn(run func() services.ServiceFactoryInterface) *MockUIInterface_GetServices_Call {
	_c.Call.Return(run)
	return _c
}
